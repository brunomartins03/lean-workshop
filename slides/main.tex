...
% Override title page to use custom logo
\makeatletter
\AtBeginDocument{%
  \setbeamertemplate{title page}{%
    \vskip\mubeamer@length@margin
    \includegraphics[height=1.2cm]{mubeamer/logo/unb.png}%
...
\title[Introdução à formalização com Lean]{Introdução à formalização de provas matemáticas com Lean 4}
\subtitle[Workshop -- SemUni 2026]{Workshop -- Semana Universitária 2026}
\author[B. Martins, V. C. Rispoli]{Bruno Martins e Vinícius C. Rispoli}
\institute[UnB/FCTE]{Universidade de Brasília -- FCTE}
\date{\the\day~de~\ifcase\month\or janeiro\or fevereiro\or mar\c{c}o\or abril\or maio\or junho\or julho\or agosto\or setembro\or outubro\or novembro\or dezembro\fi~de~\the\year}
